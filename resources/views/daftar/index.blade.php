                ...
                <form action="/daftar" method="post" enctype="multipart/form-data">
                    ...
                    <div class="account">
                        <div class="referensi-kerja mt-3">
                            ...
                            <input type="file" accept=".png, .jpg, .PNG, .jpeg, .JPEG" name="referensi_kerja"
                        ...
                        <div class="ktp mt-3">
                            ...
                            <p class="">*Upload Gambar</p>
                            <input type="file" accept=".png, .jpg, .PNG, .jpeg, .JPEG" name="ktp" id="ktp"
                                class="form-control"></p>
                        </div>
                        <div class="npwp mt-3">
                            <label for="npwp">NPWP :</label>
                            <p class="">*Upload Gambar</p>
                            <p><input type="file" accept=".png, .jpg, .PNG, .jpeg, .JPEG" name="npwp" id="npwp"
                                    class="form-control"></p>
                        </div>
                        <div class="pasphoto mt-3">
                            <label for="pasphoto">Pasphoto latar <span>merah</span> berukuran <span>3x4 = 354 X 472
                                    PX</span></label>
                            <p class="">*Upload Gambar</p>
                            <input type="file" accept=".png, .jpg, .PNG, .jpeg, .JPEG" name="pasphoto" id="pasphoto"
                                class="form-control">
                        </div>
                    </div>
