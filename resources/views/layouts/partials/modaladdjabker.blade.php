            ...
            <div class="modal-body">
                ...
                <form action="/dashboard/profil/jabatan" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="email" id="email"
                        class="form-control @error('email') is-invalid @enderror" value="{{ $one->email }}" readonly>
                    ...
                    <input type="hidden" class="custom-file-input" value="{{ $referensi_kerja }}" id="referensi_kerja"
                        accept=".pdf" name="referensi_kerja">
